...
public class Task2_4 {
    ...
    /**
     * Сжимает массив, удаляя элементы величина которых находится в заданном интервале. При некорректном вводе диапазона
     * удаления элементов выполнение метода прерывается.
     *
